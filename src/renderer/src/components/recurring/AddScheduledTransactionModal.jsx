...
function AddScheduledTransactionModal({ open, onClose, onCreate }) {
  ...
  async function handleSubmit(event) {
    ...
    if (!form.type) {
      toast.error(t('modal.validation.missingType'))
      return
    }
    if (!form.frequency) {
      toast.error(t('modal.validation.missingFrequency'))
      return
    }
